...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Define an ingredient, its unit of measure, and reorder alert threshold</p>
        </div>
        ...
        <form method="POST" action="{{ route('inventory.store') }}">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="name" 
                    value="{{ old('name') }}" 
                    placeholder="e.g. Dutch Process Cocoa Powder" 
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <select id="unit" name="unit" class="form-select @error('unit') input-error @enderror" required>
                        ...
                        <option value="ml" {{ old('unit') === 'ml' ? 'selected' : '' }}>ml (Milliliters)</option>
                        <option value="packs" {{ old('unit') === 'packs' ? 'selected' : '' }}>packs</option>
                        <option value="tubs" {{ old('unit') === 'tubs' ? 'selected' : '' }}>tubs</option>
            ...
            <div class="grid-2">
                <div class="form-group">
                    <label class="form-label" for="initial_stock">Initial Stock On Hand</label>
                    <input 
                        type="number" 
                        step="0.01" 
                        min="0" 
                        ...
                        class="form-input @error('initial_stock') input-error @enderror" 
                    >
                    @error('initial_stock')
                        <p class="error-text">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-input @error('cost_per_unit') input-error @enderror" 
                    >
                    @error('cost_per_unit')
                        <p class="error-text">{{ $message }}</p>
                    @enderror
